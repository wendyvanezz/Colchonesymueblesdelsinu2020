...
<body>
  ...
  <div class="container">
    ...
    <h1 class="mt-4 mb-3">Detalles Basecamas
      <small>Excelencia & Calidad</small>
    </h1>

    <ol class="breadcrumb">
      <li class="breadcrumb-item">
        <a href="portfolio-1-col.php">Inicio</a>
      </li>
    ...
    <div class="row">
      ...
      <div class="col-md-8">
        <img class="img-fluid" src="imagenes/bc/12.png" alt="">
      </div>

      <div class="col-md-4">
        <h3 class="my-3">Descripción</h3>
        <p>Tenemos basecamas Inmunizada, con patas en madera o metalicas, micro fibra acolchada wengue o negra, cafe o gris.tapizado con fieltros 100% naturales e higienicos y antialergicos.garantia 1 años (parte interna de la base).manejamos todas las medidas (sencilla-semidoble-doble).
        semidoble 1.00*1.90/1.20*1.90
        doble 160*190/1.40*1.90/2*2..</p>
        <h3 class="my-3">Colores</h3>
        <ul>
          <li>Negra o wengue</li>
          <li>Cafe</li>
          <li>Gris</li>
          <li>Blancas</li>
          <li>Rosadas</li>
    ...
    <div class="row">
      ...
      <div class="col-md-3 col-sm-6 mb-4">
        <a href="#">
          <img class="img-fluid" src="imagenes/bc/6.png" alt="">
        </a>
      </div>

      <div class="col-md-3 col-sm-6 mb-4">
        <a href="#">
          <img class="img-fluid" src="imagenes/bc/7.png" alt="">
        </a>
      </div>

      <div class="col-md-3 col-sm-6 mb-4">
        <a href="#">
          <img class="img-fluid" src="imagenes/bc/8.png" alt="">
        </a>
      </div>

      <div class="col-md-3 col-sm-6 mb-4">
        <a href="#">
          <img class="img-fluid" src="imagenes/bc/2.png" alt="">
        </a>
      </div>
