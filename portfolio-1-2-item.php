...
<body>
  ...
  <div class="container">
    ...
    <h1 class="mt-4 mb-3">Detalles Somier
    ...
    <div class="row">
      ...
      <div class="col-md-8">
        <img class="img-fluid" src="imagenes/bc/3.png" alt="">
      </div>

      <div class="col-md-4">
        <h3 class="my-3">Descripción</h3>
        <p>Tenemos somier, con patas en madera o metalicas, micro fibra acolchada negra, cafe o gris.tapizado con fieltros 100% naturales e higienicos y antialergicos.garantia 1 años (parte interna de la base).manejamos todas las medidas (sencilla-semidoble-doble).
        semidoble 1.20*1.90
        doble 1.40*1.90..</p>
    ...
    <div class="row">
      ...
      <div class="col-md-3 col-sm-6 mb-4">
        <a href="#">
          <img class="img-fluid" src="imagenes/bc/9.png" alt="">
        </a>
      </div>

      <div class="col-md-3 col-sm-6 mb-4">
        <a href="#">
          <img class="img-fluid" src="imagenes/bc/10.png" alt="">
        </a>
      </div>

      <div class="col-md-3 col-sm-6 mb-4">
        <a href="#">
          <img class="img-fluid" src="imagenes/bc/11.png" alt="">
        </a>
      </div>
