...
<body>
  ...
  <div class="container">
    ...
    <h1 class="mt-4 mb-3">Detalles Colchones
    ...
    <div class="row">
      ...
      <div class="col-md-8">
        <img class="img-fluid" src="imagenes/colchones/8.png" alt="">
      </div>

      <div class="col-md-4">
        <h3 class="my-3">Descripción</h3>
        <p>Estructura de resortes Bicónicos con Estabilizadores Dobles laterales, esquineros y Marco Perimetral de acero, brindando mayor firmeza estructural. Esta estructura otorga un diseño confortable y equilibrado para el descanso</p>
        <h3 class="my-3">Colores</h3>
        <ul>
          <li>Ortpedicos sencillos</li>
          <li>Ortpedicos doble</li>
          <li>Dobles</li>
          <li>Semi-ortopedicos sencillos</li>
          <li>Semi-ortopedicos dobles</li>
        </ul>
      </div>
    ...
    <h3 class="my-4">Tipos de Colchones</h3>

    <div class="row">

      <div class="col-md-3 col-sm-6 mb-4">
        <a href="#">
          <img class="img-fluid" src="imagenes/colchones/5.png" alt="">
        </a>
      </div>

      <div class="col-md-3 col-sm-6 mb-4">
        <a href="#">
          <img class="img-fluid" src="imagenes/colchones/6.png" alt="">
        </a>
      </div>

      <div class="col-md-3 col-sm-6 mb-4">
        <a href="#">
          <img class="img-fluid" src="imagenes/colchones/7.png" alt="">
        </a>
      </div>
