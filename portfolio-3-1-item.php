...
<body>
  ...
  <div class="container">
    ...
    <h1 class="mt-4 mb-3">Juegos de Sala
      <small>Excelencia & Calidad</small>
    </h1>

    <ol class="breadcrumb">
      <li class="breadcrumb-item">
        <a href="portfolio-3-col.php">Inicio</a>
      </li>
    ...
    <div class="row">
      ...
      <div class="col-md-8">
        <img class="img-fluid" src="imagenes/sala/12.png" alt="">
      </div>

      <div class="col-md-4">
        <h3 class="my-3">Descripción</h3>
        <p>Nuestros productos son diseños exclusivos 100% en madera fabricados por artesanos del sinu  de excelente calidad donde usted tambien puede enseñarlos su diseños y nosotros lo fabricamos</p>
    ...
    <div class="row">
      ...
      <div class="col-md-3 col-sm-6 mb-4">
        <a href="#">
          <img class="img-fluid" src="imagenes/sala/7.png" alt="">
        </a>
      </div>

      <div class="col-md-3 col-sm-6 mb-4">
        <a href="#">
          <img class="img-fluid" src="imagenes/sala/8.png" alt="">
        </a>
      </div>

      <div class="col-md-3 col-sm-6 mb-4">
        <a href="#">
          <img class="img-fluid" src="imagenes/sala/10.png" alt="">
        </a>
      </div>

      <div class="col-md-3 col-sm-6 mb-4">
        <a href="#">
          <img class="img-fluid" src="imagenes/sala/11.png" alt="">
        </a>
      </div>
     </div>
    <!-- /.row -->
