...
<body>
  ...
  <div class="container">
    ...
    <h1 class="mt-4 mb-3">Otros Diseños Cama sencilla
      <small>Excelencia & Calidad</small>
    </h1>

    <ol class="breadcrumb">
      <li class="breadcrumb-item">
        <a href="portfolio-2-col.php">Inicio</a>
      </li>
    ...
    <div class="row">
      ...
      <div class="col-md-8">
        <img class="img-fluid" src="imagenes/sencilla/5.png" alt="">
      </div>

      <div class="col-md-4">
        <h3 class="my-3">Descripción</h3>
        <p>Nuestros productos son diseños exclusivos 100% en madera fabricados por artesanos sampuesanos  de excelente calidad donde usted es quien eliege como desea que sea el descanso de sus hijos</p>
        <h3 class="my-3">Diseños</h3>
        <ul>
          <li>Sencillas para niños con modelos de su pelicula favorita</li>
          <li>Sencilla para niñas y adolecentes</li>
        </ul>
      </div>
    ...
    <h3 class="my-4">Estilos</h3>

    <div class="row">

      <div class="col-md-3 col-sm-6 mb-4">
        <a href="#">
          <img class="img-fluid" src="imagenes/sencilla/2.png" alt="">
        </a>
      </div>

      <div class="col-md-3 col-sm-6 mb-4">
        <a href="#">
          <img class="img-fluid" src="imagenes/sencilla/7.png" alt="">
        </a>
      </div>

      <div class="col-md-3 col-sm-6 mb-4">
        <a href="#">
          <img class="img-fluid" src="imagenes/sencilla/3.png" alt="">
        </a>
      </div>

      <div class="col-md-3 col-sm-6 mb-4">
        <a href="#">
          <img class="img-fluid" src="imagenes/sencilla/6.png" alt="">
        </a>
      </div>
