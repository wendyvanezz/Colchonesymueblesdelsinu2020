...
<body>
  ...
  <div class="container">
    ...
    <h1 class="mt-4 mb-3">Otros Diseños Camas Dobles
    ...
    <div class="row">
      ...
      <div class="col-md-8">
        <img class="img-fluid" src="imagenes/doble/1.png" alt="">
      </div>

      <div class="col-md-4">
        <h3 class="my-3">Descripción</h3>
        <p>Nuestros productos son diseños exclusivos 100% en madera fabricados por artesanos sampuesanos  de excelente calidad donde usted tambien puede enseñarlos su diseños y nosotros lo fabricamos</p>
        <h3 class="my-3">Colores</h3>
        <ul>
          <li>Caramelo</li>
          <li>Vinotinto</li>
          <li>Tapizado moderno</li>
        </ul>
      </div>
    ...
    <div class="row">
      ...
      <div class="col-md-3 col-sm-6 mb-4">
        <a href="#">
          <img class="img-fluid" src="imagenes/doble/4.png" alt="">
        </a>
      </div>

      <div class="col-md-3 col-sm-6 mb-4">
        <a href="#">
          <img class="img-fluid" src="imagenes/doble/5.png" alt="">
        </a>
      </div>

      <div class="col-md-3 col-sm-6 mb-4">
        <a href="#">
          <img class="img-fluid" src="imagenes/doble/6.png" alt="">
        </a>
      </div>

      <div class="col-md-3 col-sm-6 mb-4">
        <a href="#">
          <img class="img-fluid" src="imagenes/doble/7.png" alt="">
        </a>
      </div>
