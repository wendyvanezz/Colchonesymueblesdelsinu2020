...
<body>
  ...
  <div class="container">
    ...
    <h1 class="mt-4 mb-3">Mecedoras Catalanas
      <small>Excelencia & Calidad</small>
    </h1>

    <ol class="breadcrumb">
      <li class="breadcrumb-item">
        <a href="portfolio-7-col.php">Inicio</a>
      </li>
    ...
    <div class="row">
      ...
      <div class="col-md-8">
        <img class="img-fluid" src="imagenes/sillas/8.png" alt="">
      </div>

      <div class="col-md-4">
        <h3 class="my-3">Descripción</h3>
        <p>Hermosas mecedoras de lujo para tapizadas cómodas y perfectas para mujeres en estado de embarazo y en estado de lactancia, cómodas para hacer dormir a los bebés en sus primeros meses de nacido.Fabricadas en madera de roble, tapizadas en tela estampada de excelente calidad por los artesanos sampuesanos.</p>
    ...
    <h3 class="my-4">Otros Estilos</h3>

    <div class="row">

      <div class="col-md-4 col-sm-4 mb-4">
        <a href="#">
          <img class="img-fluid" src="imagenes/sillas/6.png" alt="">
        </a>
      </div>

      <div class="col-md-4 col-sm-4 mb-4">
        <a href="#">
          <img class="img-fluid" src="imagenes/sillas/7.png" alt="">
        </a>
      </div>

      <div class="col-md-4 col-sm-4 mb-4">
        <a href="#">
          <img class="img-fluid" src="imagenes/sillas/9.png" alt="">
        </a>
      </div>
