...
<body>
  ...
  <div class="container">
    ...
    <h1 class="mt-4 mb-3">Closets
      <small>Excelencia & Calidad</small>
    </h1>

    <ol class="breadcrumb">
      <li class="breadcrumb-item">
        <a href="portfolio-5-col.php">Inicio</a>
      </li>
    ...
    <div class="row">
      ...
      <div class="col-md-8">
        <img class="img-fluid" src="imagenes/closet/6.png" alt="">
      </div>
    ...
    <div class="row">
      ...
      <div class="col-md-3 col-sm-6 mb-4">
        <a href="#">
          <img class="img-fluid" src="imagenes/closet/7.png" alt="">
        </a>
      </div>

      <div class="col-md-3 col-sm-6 mb-4">
        <a href="#">
          <img class="img-fluid" src="imagenes/closet/8.png" alt="">
        </a>
      </div>

      <div class="col-md-3 col-sm-6 mb-4">
        <a href="#">
          <img class="img-fluid" src="imagenes/closet/9.png" alt="">
        </a>
      </div>

      <div class="col-md-3 col-sm-6 mb-4">
        <a href="#">
          <img class="img-fluid" src="imagenes/closet/10.png" alt="">
        </a>
      </div>
